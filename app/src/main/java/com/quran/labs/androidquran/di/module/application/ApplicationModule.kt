...
import com.quran.labs.androidquran.extra.memorization.ArabicVerseTextSource
import com.quran.labs.androidquran.extra.memorization.MemorizationScreenProvider
...
object ApplicationModule {
  ...
  @Provides
  @ElementsIntoSet
  fun provideExtraScreens(arabicVerseTextSource: ArabicVerseTextSource): Set<ExtraScreenProvider> {
    return setOf(MemorizationScreenProvider(arabicVerseTextSource))
  }
}
